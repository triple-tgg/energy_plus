...
CREATE TABLE `meter_type` (
  `MeterTypeId` int NOT NULL AUTO_INCREMENT,
  `MeterTypeName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `IconName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `meter_type` VALUES (1,'ไฟฟ้า','fa fa-bolt',1,'System','2021-10-18 23:05:10.000000',NULL,NULL),(2,'น้ำ','fa fa-tint',1,'System','2021-10-18 23:05:10.000000',NULL,NULL),(3,'แกีส','fa fa-fire',1,'System','2021-10-18 23:05:10.000000',NULL,NULL);
