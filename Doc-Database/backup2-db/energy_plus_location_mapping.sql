...
CREATE TABLE `location_mapping` (
  ...
  `DemandBaseline` double DEFAULT '0',
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Location_Mapping_LocationId` (`LocationId`),
  KEY `IX_Location_Mapping_MeterId` (`MeterId`),
  CONSTRAINT `FK_Location_Mapping_Location_LocationId` FOREIGN KEY (`LocationId`) REFERENCES `location` (`LocationId`) ON DELETE RESTRICT,
  CONSTRAINT `FK_Location_Mapping_Meter_MeterId` FOREIGN KEY (`MeterId`) REFERENCES `meter` (`MeterId`) ON DELETE RESTRICT
