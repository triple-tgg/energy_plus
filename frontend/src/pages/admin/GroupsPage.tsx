        ...
        <div className="ec-grid" style={{ fontFamily: "'Noto Sans Thai', system-ui, sans-serif", background: C.bg, minHeight: 'calc(100vh - 120px)', color: C.ink, padding: '0 0 24px 0' }}>
            ...
            <div style={{ background: C.bar, color: '#fff', display: 'flex', alignItems: 'stretch', borderBottom: `2px solid ${C.accent}`, marginBottom: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 16px' }}>
                    ...
                    <div>
                        <div style={{ fontFamily: MONO, fontWeight: 700, fontSize: 13, letterSpacing: 2 }}>ADMIN // GROUPS</div>
                        <div style={{ fontSize: 10, color: C.barSub, letterSpacing: 0.5 }}>บริหารจัดการกลุ่มผู้ใช้งาน (User Groups) และสิทธิ์การเข้าถึง</div>
                    </div>
                </div>
            ...
            >
                ...
                <div style={{ marginBottom: '14px' }}>
                    <label style={labelStyle}>Group Name <span style={{ color: C.red }}>*</span></label>
                    <input
                        type="text"
                        style={inputStyle}
            ...
            >
                <div style={{ textAlign: 'center', padding: '12px 0', fontFamily: MONO }}>
                    ...
                    <p style={{ fontSize: '11px', color: C.sub, marginTop: 8 }}>
                        THIS ACTION CANNOT BE UNDONE AND WILL AFFECT USERS.
                    </p>
                </div>
            </Modal>
        </div>
