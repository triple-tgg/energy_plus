...
export const metersApi = {
    ...
    getSubTypes: (params?: any) => api.get('/meters/sub-types/list', { params }),
    createSubType: (data: any) => api.post('/meters/sub-types', data),
    updateSubType: (id: number, data: any) => api.put(`/meters/sub-types/${id}`, data),
    deleteSubType: (id: number) => api.delete(`/meters/sub-types/${id}`),
...
export const alarmsApi = {
    ...
    importConfigs: (data: any[]) => api.post('/alarms/configs/import', data),
    ...
    testGroupEmail: (id: number) => api.post(`/alarms/groups/${id}/test-email`),
    ...
    getRecentMeterData: (meterId: number) => api.get(`/alarms/meter-data/${meterId}/recent`),
};
...
export const realtimeApi = {
    ...
    getMeterHistory: (params: { meterId: number; minutes?: number }) => api.get('/redis/meter-history', { params }),
